...
| **H** markdown | vendored **jcode-render-core**(`parse_markdown→Document`,含表格/列表/数学)→ 适配成角色 span(隐藏语法)、remend 防闪;FrameGlyph.style → 着色器上色、atlas 按 (style,cluster) 分桶;web 按角色选字体 | 7 content 测(含表格)+ naga shader |
